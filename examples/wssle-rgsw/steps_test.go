...
func TestRegister(t *testing.T) {
	...
	assertOneHot(t, "ctH", DecodeCoeffs(params.RLWE, dec.DecryptNew(reg.CtH), params.Delta), 0, float64(p.Commitment))
	...
	assertVec(t, "encodeH", DecodeCoeffs(params.RLWE, dec.DecryptNew(ctEcd), 2*params.Delta), wantH)
...
func TestAggregate(t *testing.T) {
	...
	assertVec(t, "agg", DecodeCoeffs(params.RLWE, dec.DecryptNew(agg), 2*params.Delta), want.h)
}
